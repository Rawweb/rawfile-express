  ...
  const experts = [
    {
      ...
      name: 'Jessca Arow',
      role: 'Designer',
      socials: [<FaTwitter className='size-5' />, <FaFacebook className='size-5' />, <FaInstagram className='size-5' />],
    },
    {
      id: 2,
      image: expert2,
      ...
      socials: [<FaTwitter className='size-5' />, <FaFacebook className='size-5' />, <FaInstagram className='size-5' />, <FaLinkedin className='size-5' />],
    },
    {
      id: 3,
      image: expert3,
      name: 'Rebecca Taylor',
      role: 'Cargo Head',
      socials: [<FaFacebook className='size-5' />, <FaInstagram className='size-5' />],
    },
    {
      id: 4,
      image: expert4,
  ...
  return (
    <section className="container py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {experts.map((member) => (
          <div key={member.id} className="flex flex-col group overflow-hidden shadow-md">
            {/* Image */}
            <div className="relative">
              ...
              <div className="absolute flex gap-3 text-primary-dark bg-primary-yellow p-3 -bottom-[5%] right-0">
                {member.socials.map((icon, i) => (
                  <span key={i} className="cursor-pointer hover:opacity-80 transition">
                    {icon}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-primary-dark p-5 text-secondary-light">
              <h2 className="font-medium text-base md:text-lg">{member.name}</h2>
